...
- Format: Strictly follow this HTML structure:
    ...
    <p>Body paragraph...</p>
- Third to last line: [LABELS]3-5 specific keyword labels relevant to this exact article, comma-separated (e.g. "Bentley, Luxury Convertible, British Craftsmanship" or "Maldives, Six Senses, Overwater Villa")[/LABELS]
